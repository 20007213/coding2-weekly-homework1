...
void Boid::draw()
{
    ofSetColor(73,231,255);
    ofDrawCircle(position.x, position.y, 6);
}

void Boid::draw2()
{
    ofSetColor(255,94,242);
    //ofCircle(position.x, position.y, 6);
    ofDrawRectangle(position.x, position.y, 23, 25);
}

void Boid::draw3()
{
    ofSetColor(229, 255, 108);
    //ofDrawTriangle(position.x, position.y, position.x+1, position.y, position.x+0.5, position.y+1);
    ofDrawEllipse(position.x, position.y, 4, 7);
}
